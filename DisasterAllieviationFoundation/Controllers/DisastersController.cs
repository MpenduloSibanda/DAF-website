...
namespace DisasterAllieviationFoundation.Controllers
{
    public class DisastersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,StartDate,EndDate,Location,Description,RequiredAid")] Disasters disasters)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,StartDate,EndDate,Location,Description,RequiredAid")] Disasters disasters)
        {
            if (id != disasters.ID)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DisastersExists(disasters.ID))
                    {
                        return NotFound();
                    }
                    else
